...
//Probamos el Calendario++
    ...
    calendario1.ModFecha(1, 1, 2015); //AÒo normal
    calendario2.ModFecha(1, 1, 2016); //AÒo bisiesto

    calendario1 = calendario1+(365);  //Resultado correcto, justo un aÒo despues 01/01/2016
    calendario2 = calendario2+(365);  //Resultado correcto, un aÒo despues menos un dia 12/12/2016
...
//************************************************************************
    ...
    {
        cout << "ERROR! a deberÌa haber tomado el valor de c y no ha sido asi"<<endl;
    }
    else
    {
        cout << "prueba 2 ----> OK" <<endl;
...
//*************************************************************************************************************
   ...
   TVectorCalendario p5_1(3);
   p5_1[1]=ca1;
   p5_1[2]=ca2;
   p5_1[3]=ca3;

   TVectorCalendario p5_2(3);
   p5_2[1]=ca1;
   p5_2[2]=ca2;
   p5_2[3]=ca3;
   ...
   {
       cout << "ERROR: Reduciendo el tamaÒo del vector"<< endl;
   }
   ...
   {
       cout << "ERROR: Aumentando el tamaÒo del vector"<< endl;
   }
...
//Constructor de copa
    ...
    {
        cout << "ERROR: se borra en lista1 y se borra tambien de la lista 2 (ømismos punteros?)"<<endl;
    }
